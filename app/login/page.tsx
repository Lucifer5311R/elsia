        ...
        <div className="py-20 bg-background min-h-screen flex items-center justify-center">
            <Container>
                <div className="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                    <h1 className="text-4xl font-bold font-caveat mb-6 text-center">Welcome Back</h1>
                    ...
                    <button
                        ...
                        className="w-full bg-white text-slate-700 font-bold py-3 rounded-lg border border-slate-300 shadow-sm hover:bg-slate-50 transition flex items-center justify-center gap-2 mb-6"
                    >
